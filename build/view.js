  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("style", {
    dangerouslySetInnerHTML: {
      __html: `
          ...
          ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)("", styles?.content?.button?.typo)?.googleFontLink}
...
const OneCard = ({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("section", {
    ...
    className: "card-list"
  }, cardsData.map((card, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", {
    key: card?.id || index
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: "meta"
  }, options.isTitle && !RichTextControl && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h3", {
    className: "title"
  }, card.title), options?.isTitle && RichTextControl && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(RichTextControl, {
    className: "title",
    value: card.title,
    onChange: value => setAttributes({
      cardsData: (0,_bpl_tools_utils_functions__WEBPACK_IMPORTED_MODULE_1__.updateData)(cardsData, value, index, "title")
    })
  }), options.isDescription && !RichTextControl && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
    className: "desc"
  }, card.description), options?.isDescription && RichTextControl && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(RichTextControl, {
    className: "desc",
    value: card.description,
    onChange: value => setAttributes({
      cardsData: (0,_bpl_tools_utils_functions__WEBPACK_IMPORTED_MODULE_1__.updateData)(cardsData, value, index, "description")
    })
  })), options.isButton && !RichTextControl && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    href: card.linkUrl,
  ...
  })), options.isButton && RichTextControl && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "oneCardEditorButton"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(RichTextControl, {
    className: "link",
    value: card.linkText,
    onChange: value => setAttributes({
      cardsData: (0,_bpl_tools_utils_functions__WEBPACK_IMPORTED_MODULE_1__.updateData)(cardsData, value, index, "linkText")
    })
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  blockNameEls.forEach(blockNameEl => {
    ...
    (0,react_dom_client__WEBPACK_IMPORTED_MODULE_1__.createRoot)(blockNameEl).render((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_Common_Style__WEBPACK_IMPORTED_MODULE_3__["default"], {
      ...
      id: blockNameEl.id
    }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_Common_cards_OneCard__WEBPACK_IMPORTED_MODULE_4__["default"], {
      attributes: attributes
    })));
